  ...
  return (
    <div className="flex-1 flex items-center justify-center px-4 sm:px-6 py-6 sm:py-10">
      <form onSubmit={handleSubmit} className="w-full max-w-md bg-white/10 backdrop-blur-sm p-6 sm:p-8 rounded-xl">
        <h2 className="text-xl sm:text-2xl font-bold mb-4 text-white">Sign Up</h2>
        ...
        <button type="submit" className="w-full py-3 rounded bg-gradient-to-r from-green-500 to-teal-500 text-white text-sm sm:text-base">Sign up</button>
